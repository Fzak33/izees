...
class CategoryDailyCharts extends StatelessWidget {
  const CategoryDailyCharts({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<DayProfitCubit, DayProfitState>(
      builder: (context, state) {
        if(state is DayProfitLoading){
          return const Center(child: CircularProgressIndicator(),);
        }
        else if(state is DayProfitFailed){
          return Center(child: Text(state.err),);
        }else if(state is DayProfitSuccess){
