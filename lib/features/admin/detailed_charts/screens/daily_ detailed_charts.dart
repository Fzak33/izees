...
class DailyDetailedCharts extends StatelessWidget {
  const DailyDetailedCharts({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: BlocBuilder<DailyProductProfitCubit, DailyProductProfitState>(
          builder: (context, state) {
            if(state is DailyProductProfitLoading){
              return const Center(child: CircularProgressIndicator(),);
            }
            else if(state is DailyProductProfitFailed){
