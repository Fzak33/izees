...
//
//   Future<void> addToCart({required Product product,required String id, required BuildContext context, })async{
//  await _cartServices.addToCart(id:id,context:context , product: product);
